...
export default function Page() {
  ...
  return (
    <div className="fixed bg-orange-100 overflow-auto h-full w-full">
      <div className="h-[90px] bg-white  w-full shadow-md fixed">
        <span className="flex space-x-24 mt-8 mr-6 ml-6">
          <Link href="/">
            <SlArrowLeft className="border-2 text-center mb-1 rounded px-2 py-2 w-[40px] h-[40px]" />
          </Link>
          <h1 className="font-semibold mr-4 text-center text-[22px]">
            Add Money
          </h1>
        </span>
      </div>
      <div className="ml-6 mr-6 bg-white shadow-lg border-2 rounded-md px-4 py-4 mt-44">
        ...
        <div className="grid grid-cols-4 grid-rows-2 gap-2 pt-4 px-2 mt-6">
          <button
            className="bg-white border-2 shadow-md  rounded-md w-18 py-2 text-center text-xs"
